...
public class WSVehiculoServiceLocator extends org.apache.axis.client.Service
		implements com.ipartek.formacion.dgt.wssoap.WSVehiculoService {
	...
	public WSVehiculoServiceLocator(java.lang.String wsdlLoc, javax.xml.namespace.QName sName)
	...
	public com.ipartek.formacion.dgt.wssoap.WSVehiculo getWSVehiculo(java.net.URL portAddress)
			throws javax.xml.rpc.ServiceException {
		try {
			com.ipartek.formacion.dgt.wssoap.WSVehiculoSoapBindingStub _stub = new com.ipartek.formacion.dgt.wssoap.WSVehiculoSoapBindingStub(
					portAddress, this);
	...
	public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
		try {
			if (com.ipartek.formacion.dgt.wssoap.WSVehiculo.class.isAssignableFrom(serviceEndpointInterface)) {
				com.ipartek.formacion.dgt.wssoap.WSVehiculoSoapBindingStub _stub = new com.ipartek.formacion.dgt.wssoap.WSVehiculoSoapBindingStub(
						new java.net.URL(WSVehiculo_address), this);
				_stub.setPortName(getWSVehiculoWSDDServiceName());
				return _stub;
			}
